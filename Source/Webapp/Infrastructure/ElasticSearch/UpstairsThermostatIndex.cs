...
{
    public class UpstairsThermostatIndex : ElasticIndex
    {
        ...
        public override string IndexName { get; } = "upstairs.temperature";

        public UpstairsThermostatIndex(Lazy<ElasticSearchService> elasticSearch)
            : base(elasticSearch)
        {
